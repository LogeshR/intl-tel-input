...
(function(factory) {
   ...
   ********************/
        ...
        // freshfone code
        initPreferredCountries: function () {
        //  if(freshfonecalls.recentCaller != 1){
              this._selectFlag($.parseJSON(JSON.parse(localStorage.getItem("callerPreference")))[0]);
        ...
        initLSCountries: function() {
            ...
            //    var outgoingNumber = this.selectFreshfoneNumber();
            //    if (outgoingNumber) {
            //         freshfone.country_preference = $.parseJSON('[' + freshfone.original_stringify(this._getCountryData(this._getCountryCode(outgoingNumber)[0]).iso2) + ']');
            //     } else {
            //          freshfone.country_preference = ["us"];
            //     }
        ...
        _getCountryCode: function(number) {
            ...
            return this.countryCodes[this._getNumeric(dialCode)];
        },
        selectFreshfoneNumber: function() {
            var number="";
            try{
            //    number = (typeof(freshfonecalls) == "undefined") ? freshfone.numbersHash[1] : freshfonecalls.outgoingNumber();
            } catch(err) {
                console.log("Unable to initialise preferred country", err);
            }
            return number;
        },
       ...
       //   freshfone.country_preference.unshift(freshfonecalls.callerLocation().toLowerCase());
        ...
        _generateMarkup: function() {
            ...
            // freshfone code
            this.searchHeaderBar=$("<div>",{"class":""})
            this.searchBar = $("<div>" , {
                "class" : "country-search hide"
            }).appendTo(this.flagsContainer);
            this.searchBarTitle=$("<div>",{"class":"header","text":"COUNTRY CODE"}).appendTo(this.searchBar);
            this.backArrow = $("<div>", {
              "class": "backArrow", "id":"countrySearchBackArrow"
            }).appendTo(this.searchBar);
            this.arrowLeft=$("<div>", {
              "class": "arrow-left move-back",
            }).appendTo(this.backArrow);
            $("<i>",{"class":"icon-back"}).appendTo(this.arrowLeft);
            $("<input>", {
              "class": "search-bar",
        ...
        _loadAutoCountry: function() {
            ...
            if (this.options.preferredCountries) {
                $.fn[pluginName].autoCountry = freshfone.country_preference[0];
            }
            // 3 options:
        ...
        _bindDropdownListeners: function() {
            ...
            $("#countrySearchBar").on("focus" + this.ns, function(){
              ...
              // freshfone code
            $("#countrySearchBackArrow").click(function(){
                console.log('back arrow call triggered')
                that._closeDropdown();
            });
            // click off to close
        ...
        _getCountryData: function(countryCode, ignoreOnlyCountriesOption, allowFail) {
            ...
            if (allowFail) {
                ...
                console.log("No country data for", countryCode);
                return countryList[222];
            }
        },
        ...
        _selectFlag: function(countryCode, updateDefault) {
            ...
            this.selectedFlagInner.attr("class", "iti-flag " + this.selectedCountryData.iso2);
   ...
   ********************/
        ...
        getDialCode: function() {
          var number = this.telInput.val();
          return this._getDialCode(number);
        }
